...
| `:DookuAutoSetup` | It will download the necessary config file in your project root directory, so you can run `:DookuGenerate` without having to configure anything. |
